...
build_macos_arm64:
	( cd ./$(TARGETDIR) && \
	$(BUILD_OPENSSL) --targets="mac-catalyst-arm64" --ec-nistp-64-gcc-128 --version=1.1.0f && \
...
build_sim_arm64:
	( cd ./$(TARGETDIR) && \
	$(BUILD_OPENSSL) --targets="ios-sim-cross-arm64" --ec-nistp-64-gcc-128 --version=1.1.0f && \
